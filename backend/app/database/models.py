...
class AnnotationLabel(Base):
    ...
    annotator_email: Mapped[str] = mapped_column(String(256), default="")
    annotator_profession: Mapped[str] = mapped_column(String(256), default="")
    annotator_linkedin: Mapped[str] = mapped_column(String(512), default="")
